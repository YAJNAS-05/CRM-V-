...
export interface ComposedDashboardWidget {
  key: string
  title: string
  type: string
  value: any
...
export interface ComposedDashboard {
  scope: 'SELF' | 'TEAM'
  roles: string[]
  widgets: ComposedDashboardWidget[]
  generatedAt: string
}
...
export const dashboardApi = {
  ...
  getComposedDashboard: (roles?: string[]) =>
    axiosInstance.get<{ data: ComposedDashboard }>('/v1/dashboards/compose', {
