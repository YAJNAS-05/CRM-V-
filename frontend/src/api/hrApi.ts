...
export const onboardingTaskApi = {
  getAll: (page = 0, size = 50, params?: { employeeId?: string; status?: string; category?: string }) =>
    axiosInstance.get<ApiResponse<Page<OnboardingTask>>>(
      `/v1/hr/onboarding-tasks?${buildQueryString(page, size, params as any)}`,
    ),
  create: (data: Omit<OnboardingTask, 'id' | 'createdAt'>) =>
    axiosInstance.post<ApiResponse<OnboardingTask>>('/v1/hr/onboarding-tasks', data),
  update: (id: string, data: Partial<OnboardingTask>) =>
    axiosInstance.put<ApiResponse<OnboardingTask>>(`/v1/hr/onboarding-tasks/${id}`, data),
  delete: (id: string) =>
    axiosInstance.delete<ApiResponse<void>>(`/v1/hr/onboarding-tasks/${id}`),
}

export const appraisalGoalApi = {
  getAll: (page = 0, size = 50, ownerId?: string) =>
    axiosInstance.get<ApiResponse<Page<AppraisalGoal>>>(
      `/v1/hr/appraisal/goals?${buildQueryString(page, size, { ownerId })}`,
    ),
  create: (data: Omit<AppraisalGoal, 'id'>) =>
    axiosInstance.post<ApiResponse<AppraisalGoal>>('/v1/hr/appraisal/goals', data),
  update: (id: string, data: Partial<AppraisalGoal>) =>
    axiosInstance.put<ApiResponse<AppraisalGoal>>(`/v1/hr/appraisal/goals/${id}`, data),
  delete: (id: string) =>
...
export const hrTaskApi = {
  getAll: (page = 0, size = 200, params?: { projectId?: string; assigneeId?: string }) =>
    axiosInstance.get<ApiResponse<Page<HrTaskRecord>>>(
      `/v1/hr/tasks?${buildQueryString(page, size, params as any)}`,
    ),
  create: (data: {
    projectId: string
    taskTitle: string
    ...
    priority?: string
    dueDate?: string
  }) => axiosInstance.post<ApiResponse<HrTaskRecord>>('/v1/hr/tasks', data),
  update: (id: string, data: {
    ...
    priority?: string
    dueDate?: string
  }) => axiosInstance.put<ApiResponse<HrTaskRecord>>(`/v1/hr/tasks/${id}`, data),
  delete: (id: string) => axiosInstance.delete<ApiResponse<void>>(`/v1/hr/tasks/${id}`),
}
