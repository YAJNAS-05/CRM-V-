...
export const ReportListPage = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {!CUSTOM_REPORTS_AVAILABLE && (
        <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          Custom reports are currently disabled because no supported backend or draft mode is enabled.
        </div>
      )}
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <FeatureGate requiredPermission="REPORTS">
            <button
              disabled={!CUSTOM_REPORTS_AVAILABLE}
              onClick={() => navigate('/reports/custom')}
              className="px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
            >
              + New Custom Report
            </button>
          </FeatureGate>
