  ...
  return (
    <div className="space-y-6">
      <FinanceModuleHeader
        ...
        subtitle="Maintain currency conversion rates used for cross-entity reporting and AUD equivalent calculations."
        metrics={[
          { label: 'Configured Rates', value: rates.length },
          { label: 'Sync Cadence', value: 'Daily 1:00 AM' },
          { label: 'Base Reporting', value: 'AUD' },
          { label: 'Service Status', value: 'Active', accentClassName: 'text-emerald-700' },
        ]}
      />
      ...
      <div className="shell-card mt-12 border-dashed border-gray-300 p-6">
