    ...
    <div className="space-y-6">
      <div className="shell-card p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Financial Close</h1>
            <p className="mt-1 text-sm text-slate-500">Run month-end checks, resolve exceptions, and close the posting period.</p>
          </div>
