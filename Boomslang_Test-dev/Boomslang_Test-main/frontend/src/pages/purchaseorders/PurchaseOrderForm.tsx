...
export default function PurchaseOrderForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!form.poNumber || !form.supplierId || !form.status) { toast.error('PO Number, Supplier ID, and Status are required'); return }
    try {
      setSaving(true)
      const payload = {
        ...form,
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input type="text" name="supplierId" value={form.supplierId} onChange={handleChange} required placeholder="UUID" className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              <div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input type="text" name="paymentMethod" value={form.paymentMethod} onChange={handleChange} maxLength={50} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              <div>
