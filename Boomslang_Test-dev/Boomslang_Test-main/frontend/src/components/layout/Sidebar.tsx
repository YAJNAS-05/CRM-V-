...
const Sidebar: React.FC<SidebarProps> = ({ collapsed, mobileOpen, onClose }) => {
  ...
  const moduleViewPermissions: Record<string, string[]> = {
    CRM: ['CRM_VIEW', 'DASHBOARD_SELF_VIEW', 'DASHBOARD_TEAM_VIEW'],
    ERP: ['ERP_VIEW'],
  ...
  const menuGroups: MenuGroup[] = [
    {
      title: 'CRM',
      items: [
        { name: 'User Dashboard', path: '/crm/dashboard/user', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
        { name: 'Team Dashboard', path: '/crm/dashboard/team', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
